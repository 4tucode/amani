...
// Datos de productos olfativos únicos
const productos = ref([
  {
    id: 1,
    nombre: "Aromas Ancestrales del África Occidental",
    descripcion: "Sumérgete en el mundo de las fragancias tradicionales africanas. Descubre esencias milenarias, hierbas aromáticas y perfumes naturales que han sido utilizados por generaciones para rituales, ceremonias y bienestar espiritual.",
    precio: "79.99",
  ...
  {
    id: 2,
    nombre: "Esencias de la Sabana",
    descripcion: "Fragancias auténticas extraídas de plantas nativas de la sabana africana. Cada aroma cuenta una historia de tradición y conexión con la naturaleza salvaje del continente.",
    precio: "89.99",
    categoria: "Esencias Naturales",
    rating: 4.9,
    stock: 12,
    imagen: "olfato2.jpg"
  },
  {
    id: 3,
    nombre: "Perfumes del Desierto",
    descripcion: "Aromas intensos y misteriosos que evocan la majestuosidad del desierto del Sahara. Fragancias que transportan a paisajes de dunas infinitas y noches estrelladas.",
    precio: "95.99",
    categoria: "Perfumes",
    rating: 4.7,
    stock: 8,
  ...
  {
    id: 4,
    nombre: "Inciensos Sagrados",
    descripcion: "Inciensos tradicionales utilizados en ceremonias espirituales africanas. Cada varilla está impregnada con resinas sagradas y hierbas medicinales ancestrales.",
    precio: "65.99",
    categoria: "Inciensos",
    rating: 4.6,
    stock: 25,
  ...
  {
    id: 5,
    nombre: "Aceites Esenciales Puros",
    descripcion: "Aceites esenciales 100% naturales extraídos de plantas africanas. Cada gota contiene la esencia pura de la naturaleza salvaje del continente.",
    precio: "120.99",
  ...
  {
    id: 6,
    nombre: "Fragancias del Bosque",
    descripcion: "Aromas que capturan la esencia de los bosques tropicales africanos. Fragancias frescas y revitalizantes que conectan con la energía de la selva.",
    precio: "85.99",
    ...
    <div class="py-16">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div v-for="producto in productosFiltrados" :key="producto.id" class="polaroid-card group">
            ...
            <div class="polaroid-image">
              <img :src="`@/assets/${producto.imagen}`" :alt="producto.nombre" class="polaroid-photo" />
            </div>
        ...
        <div v-if="productosFiltrados.length === 0" class="text-center py-16">
          ...
          <p class="text-gray-500">Vuelve más tarde para descubrir nuevas experiencias olfativas</p>
        </div>
      </div>
