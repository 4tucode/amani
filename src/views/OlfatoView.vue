...
useProductosJsonLd('productos-olfato', '/experiencia/olfato', productos)
onMounted(() => cargarPorSentido('olfato'))
...
<template>
  <div class="olfato-view" ref="rootEl">
    ...
    <div class="page-header" data-reveal>
      ...
      <div class="header-center">
        <div class="eyebrow">
          <span class="ew-line" />
          <span class="ew-text">Sentido · Olfato</span>
          <span class="ew-line" />
        </div>
        <h1 class="page-title">Colección Olfativa</h1>
      </div>

      <blockquote class="header-quote">
        <p>Aromas que evocan la esencia de África</p>
      </blockquote>
    </div>
