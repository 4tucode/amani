...
useProductosJsonLd('productos-oido', '/experiencia/oido', productos)
...
<template>
  <div class="oido-view" ref="rootEl">
    ...
    <div class="page-header" data-reveal>
      ...
      <div class="header-center">
        <div class="eyebrow">
          <span class="ew-line" />
          <span class="ew-text">Sentido · Oído</span>
          <span class="ew-line" />
        </div>
        <h1 class="page-title">Colección Sonora</h1>
      </div>

      <blockquote class="header-quote">
        <p>Instrumentos artesanales que dan voz a la tradición africana</p>
      </blockquote>
    </div>
